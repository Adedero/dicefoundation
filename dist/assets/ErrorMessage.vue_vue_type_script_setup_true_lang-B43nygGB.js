import{B as S,S as x,J as B,I as O,f as P,L as I,c as p,o as a,w,M as f,a as k,A as r,G as m,b as i,k as g,H as C,N as D,aD as A,ay as E,aY as z,aZ as $,aT as M,d as T,i as N,j as h,t as F,s as L}from"./index-WTmT20yY.js";var R=function(s){var e=s.dt;return`
.p-message {
...
`)},V={root:function(s){var e=s.props;return["p-message p-component p-message-"+e.severity,{"p-message-outlined":e.variant==="outlined","p-message-simple":e.variant==="simple","p-message-sm":e.size==="small","p-message-lg":e.size==="large"}]},content:"p-message-content",icon:"p-message-icon",text:"p-message-text",closeButton:"p-message-close-button",closeIcon:"p-message-close-icon"},K=S.extend({name:"message",theme:R,classes:V}),U={name:"BaseMessage",extends:O,props:{severity:{type:String,default:"info"},closable:{type:Boolean,default:!1},life:{type:Number,default:null},icon:{type:String,default:void 0},closeIcon:{type:String,default:void 0},closeButtonProps:{type:null,default:null},size:{type:String,default:null},variant:{type:String,default:null}},style:K,provide:function(){return{$pcMessage:this,$parentInstance:this}}},j={name:"Message",extends:U,inheritAttrs:!1,emits:["close","life-end"],timeout:null,data:function(){return{visible:!0}},mounted:function(){var s=this;this.life&&setTimeout(function(){s.visible=!1,s.$emit("life-end")},this.life)},methods:{close:function(s){this.visible=!1,this.$emit("close",s)}},computed:{closeAriaLabel:function(){return this.$primevue.config.locale.aria?this.$primevue.config.locale.aria.close:void 0}},directives:{ripple:B},components:{TimesIcon:x}};function l(n){"@babel/helpers - typeof";return l=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(s){return typeof s}:function(s){return s&&typeof Symbol=="function"&&s.constructor===Symbol&&s!==Symbol.prototype?"symbol":typeof s},l(n)}function y(n,s){var e=Object.keys(n);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(n);s&&(o=o.filter(function(c){return Object.getOwnPropertyDescriptor(n,c).enumerable})),e.push.apply(e,o)}return e}function v(n){for(var s=1;s<arguments.length;s++){var e=arguments[s]!=null?arguments[s]:{};s%2?y(Object(e),!0).forEach(function(o){G(n,o,e[o])}):Object.getOwnPropertyDescriptors?Object.defineProperties(n,Object.getOwnPropertyDescriptors(e)):y(Object(e)).forEach(function(o){Object.defineProperty(n,o,Object.getOwnPropertyDescriptor(e,o))})}return n}function G(n,s,e){return(s=H(s))in n?Object.defineProperty(n,s,{value:e,enumerable:!0,configurable:!0,writable:!0}):n[s]=e,n}function H(n){var s=J(n,"string");return l(s)=="symbol"?s:s+""}function J(n,s){if(l(n)!="object"||!n)return n;var e=n[Symbol.toPrimitive];if(e!==void 0){var o=e.call(n,s);if(l(o)!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return(s==="string"?String:Number)(n)}var Y=["aria-label"];function Z(n,s,e,o,c,t){var b=P("TimesIcon"),u=I("ripple");return a(),p(E,r({name:"p-message",appear:""},n.ptmi("transition")),{default:w(function(){return[f(k("div",r({class:n.cx("root"),role:"alert","aria-live":"assertive","aria-atomic":"true"},n.ptm("root")),[n.$slots.container?m(n.$slots,"container",{key:0,closeCallback:t.close}):(a(),i("div",r({key:1,class:n.cx("content")},n.ptm("content")),[m(n.$slots,"icon",{class:C(n.cx("icon"))},function(){return[(a(),p(D(n.icon?"span":null),r({class:[n.cx("icon"),n.icon]},n.ptm("icon")),null,16,["class"]))]}),n.$slots.default?(a(),i("div",r({key:0,class:n.cx("text")},n.ptm("text")),[m(n.$slots,"default")],16)):g("",!0),n.closable?f((a(),i("button",r({key:1,class:n.cx("closeButton"),"aria-label":t.closeAriaLabel,type:"button",onClick:s[0]||(s[0]=function(d){return t.close(d)})},v(v({},n.closeButtonProps),n.ptm("closeButton"))),[m(n.$slots,"closeicon",{},function(){return[n.closeIcon?(a(),i("i",r({key:0,class:[n.cx("closeIcon"),n.closeIcon]},n.ptm("closeIcon")),null,16)):(a(),p(b,r({key:1,class:[n.cx("closeIcon"),n.closeIcon]},n.ptm("closeIcon")),null,16,["class"]))]})],16,Y)),[[u]]):g("",!0)],16))],16),[[A,c.visible]])]}),_:3},16)}j.render=Z;const X=z({baseUrl:"https://dicefoundation",options:{beforeFetch({options:n}){return n.headers={...n.headers,Accept:"application/json, text/plain"},{options:n}},async onFetchError({error:n,response:s}){if((s==null?void 0:s.status)===401)return $(window.location.pathname),{error:n,response:s};const e=await(s==null?void 0:s.json());return n&&e&&(n.message=e.message),{error:n,response:s}}}}),_=z({baseUrl:"https://dicefoundation/api",options:{beforeFetch({options:n,cancel:s}){var c;const o=(c=M().user)==null?void 0:c.token;return o||s(),n.headers={...n.headers,Authorization:`Bearer ${o}`,Accept:"application/json, text/plain"},{options:n}},async onFetchError({error:n,response:s}){if((s==null?void 0:s.status)===401)return $(window.location.pathname),{error:n,response:s};const e=await(s==null?void 0:s.json());return n&&e&&(n.message=e.message),{error:n,response:s}}}}),q={key:0,class:"w-full"},Q={key:0,class:"flex justify-end"},ee=T({__name:"ErrorMessage",props:{closable:{type:Boolean,default:!0},error:{},life:{},reload:{type:Boolean,default:!0},shouldRetry:{type:Boolean,default:!1},size:{default:"small"}},emits:["retry"],setup(n,{emit:s}){const e=s,o=N(()=>n.error?typeof n.error=="string"?n.error:n.error.message:""),c=()=>{e("retry"),n.reload&&window.location.reload()};return(t,b)=>{const u=L,d=j;return o.value?(a(),i("div",q,[h(d,{severity:"error",size:t.size,closable:t.closable,life:t.life},{default:w(()=>[k("p",null,F(o.value),1),t.shouldRetry?(a(),i("div",Q,[h(u,{onClick:c,size:"small",severity:"danger",label:"Retry"})])):g("",!0)]),_:1},8,["size","closable","life"])])):g("",!0)}}});export{_ as $,ee as _,X as a,j as s};
